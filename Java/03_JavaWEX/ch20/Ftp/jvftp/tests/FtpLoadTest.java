...
public class FtpLoadTest {
    public static void main(String args[]) {
        ...
        FtpConnect cn = FtpConnect.newConnect("ftp://192.168.0.192/");
        /* Guest login ok, send your e-mail as password */
		cn.setUserName("anonymous");
 //       cn.setPassWord("julianno");
        Ftp cl = new Ftp();
        ...
        try { /* connect & login to host */
            ...
            CoFile file = new FtpFile("BitcTest/boot.ini", cl);
            System.out.println("From: " + file.toString());

            /* destination LocalFile home dir */
            CoFile to =
                new LocalFile(System.getProperty("user.dir"), "boot.ini");
